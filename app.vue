    ...
    <div class="pointer-events-none fixed start-0 top-0 z-[60] flex h-full xl:z-10">
      <div
        ...
        <div class="flex h-16 w-full items-center justify-center">
          <NuxtLink to="/" class="flex items-center justify-center"><svg version="1.1" xmlns="http://www.w3.org/2000/svg"
              xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 500 500" xml:space="preserve"
              class="shrink-0 text-primary-600 h-10">
              <g>
                <g>
                  <defs>
      ...
      c-45.1-7.9-82-39.7-97.1-81.9c-5.2-14.5-16.8-24.3-31.9-27C253.7,79.2,241.2,78,228.4,78z"></path>
                  ...
                  <use xlink:href="#LOGOSVGID_1_" clip-rule="evenodd" fill-rule="evenodd" fill="currentColor"
                    class="overflow-visible"></use>
                  <clipPath id="LOGOSVGID_2_">
                    <use xlink:href="#LOGOSVGID_1_" class="overflow-visible"></use>
                  </clipPath>
                  <rect x="17.4" y="78" clip-path="url(#LOGOSVGID_2_)" width="422" height="422" fill="currentColor">
                  </rect>
                </g>
                <g>
                  <defs>
      ...
      C351,29.5,380.5,0,416.8,0"></path>
                  ...
                  <use xlink:href="#LOGOSVGID_3_" clip-rule="evenodd" fill-rule="evenodd" fill="currentColor"
                    class="overflow-visible"></use>
                  <clipPath id="LOGOSVGID_4_">
                    <use xlink:href="#LOGOSVGID_3_" class="overflow-visible"></use>
                  </clipPath>
                  <rect x="351" y="0" clip-path="url(#LOGOSVGID_4_)" width="131.6" height="131.6" fill="currentColor">
                  </rect>
                </g>
              </g>
            </svg></NuxtLink>
        ...
        <div>
          <div class="flex h-16 w-full items-center justify-center">
            <span></span><button type="button"
              class="flex h-12 w-12 items-center justify-center rounded-2xl transition-colors duration-300 bg-primary-100 text-primary-500 dark:bg-primary-500/10"
              data-tooltip-position="right" data-tooltip="Dashboards">
              <svg data-v-cd102a71="" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                aria-hidden="true" role="img" class="icon w-5 h-5" width="1em" height="1em" viewBox="0 0 256 256">
                <g fill="currentColor">
        ...
        <div class="mt-auto">
          <div class="flex h-16 w-full items-center justify-center">
            <span></span><a href="/layouts/profile-settings"
              class="text-muted-400 flex h-12 w-12 items-center justify-center rounded-2xl transition-colors duration-300"
              data-tooltip-position="right" data-tooltip="Settings"><svg data-v-cd102a71=""
                xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true"
                role="img" class="icon w-5 h-5" width="1em" height="1em" viewBox="0 0 256 256">
                <g fill="currentColor">
                  <path
      ...
      <div
        class="border-muted-200 dark:border-muted-700 dark:bg-muted-800 pointer-events-auto relative z-10 h-full w-[220px] border-r bg-white transition-all duration-300 rtl:translate-x-[calc(100%_+_80px)] translate-x-[calc(-100%_-_80px)]">
        <div class="flex h-screen flex-col">
          <div class="flex h-16 w-full items-center px-6">
            ...
            <button type="button"
              ...
              <svg data-v-cd102a71="" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                aria-hidden="true" role="img" class="icon h-6 w-6" width="1em" height="1em" viewBox="0 0 24 24">
            ...
            <div class="px-6 pb-8">
              <ul>
                <li class="group mb-1 min-h-[2rem]">
                  <a href="#" class="nui-focus relative top-0.5 flex items-center"><span
                      class="text-muted-400 group-hover:text-primary-500 relative inline-flex items-center gap-2 font-sans text-sm transition-colors duration-300"><span
                        class="bg-primary-500 absolute -start-3 top-2 h-1 w-1 rounded-full"></span><span>Personal</span></span><svg
                      data-v-cd102a71="" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                      aria-hidden="true" role="img"
                      class="icon text-muted-400 ms-auto block h-4 w-4 transition-transform duration-300 rotate-180"
                      width="1em" height="1em" viewBox="0 0 24 24">
                      <path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                        stroke-width="2" d="m6 9l6 6l6-6"></path>
                    </svg></a>
                  <div class="transition-all duration-150 max-h-max opacity-100">
                    <ul class="py-2">
                      <li class="flex h-8 w-full items-center">
                        <a href="/dashboards"
                          class="nui-focus text-muted-400 hover:text-primary-500 focus:text-primary-500 flex w-full items-center ps-3 transition-colors duration-300"><svg
                            data-v-cd102a71="" xmlns="http://www.w3.org/2000/svg"
                            xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img"
                            class="icon me-2 h-5 w-5" width="1em" height="1em" viewBox="0 0 256 256">
                            <g fill="currentColor">
                              <path d="M208 88v48a88 88 0 0 1-51.3 80H83.3A88 88 0 0 1 32 136V88Z" opacity=".2"></path>
                              <path
                                d="M80 56V24a8 8 0 0 1 16 0v32a8 8 0 0 1-16 0Zm40 8a8 8 0 0 0 8-8V24a8 8 0 0 0-16 0v32a8 8 0 0 0 8 8Zm32 0a8 8 0 0 0 8-8V24a8 8 0 0 0-16 0v32a8 8 0 0 0 8 8Zm96 56v8a40 40 0 0 1-37.51 39.91a96.59 96.59 0 0 1-27 40.09H208a8 8 0 0 1 0 16H32a8 8 0 0 1 0-16h24.54A96.3 96.3 0 0 1 24 136V88a8 8 0 0 1 8-8h176a40 40 0 0 1 40 40Zm-48-24H40v40a80.27 80.27 0 0 0 45.12 72h69.76A80.27 80.27 0 0 0 200 136Zm32 24a24 24 0 0 0-16-22.62V136a95.78 95.78 0 0 1-1.2 15a24 24 0 0 0 17.2-23Z">
                              </path>
                            </g>
                          </svg><span class="font-sans text-xs">Personal V1</span></a>
                      </li>
                      <li class="flex h-8 w-full items-center">
                        <a href="/dashboards/personal-2"
                          class="nui-focus text-muted-400 hover:text-primary-500 focus:text-primary-500 flex w-full items-center ps-3 transition-colors duration-300"><svg
                            data-v-cd102a71="" xmlns="http://www.w3.org/2000/svg"
                            xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img"
                            class="icon me-2 h-5 w-5" width="1em" height="1em" viewBox="0 0 256 256">
                            <g fill="currentColor">
                              <path d="M96 37.5v72l-62.4 36A96 96 0 0 1 96 37.5Z" opacity=".2"></path>
                              <path
                          ...
                          </svg><span class="font-sans text-xs">Personal V2</span></a>
                      </li>
                      <li class="flex h-8 w-full items-center">
                        <a aria-current="page" href="/dashboards/personal-3"
                          class="router-link-active router-link-exact-active text-primary-500 nui-focus text-muted-400 hover:text-primary-500 focus:text-primary-500 flex w-full items-center ps-3 transition-colors duration-300"><svg
                            data-v-cd102a71="" xmlns="http://www.w3.org/2000/svg"
                            xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img"
                            class="icon me-2 h-5 w-5" width="1em" height="1em" viewBox="0 0 256 256">
                            <g fill="currentColor">
                              <path
                                d="M232 116a60 60 0 0 1-60 60h-12v40H96v-80H84a60 60 0 0 1-60-60a20 20 0 0 1 20-20a20 20 0 0 1 20 20a20 20 0 0 0 20 20h12V56a32 32 0 0 1 32-32a32 32 0 0 1 32 32v80h12a20 20 0 0 0 20-20a20 20 0 0 1 20-20a20 20 0 0 1 20 20Z"
                                opacity=".2"></path>
                              <path
                                d="M216 208h-48v-24h4a68.07 68.07 0 0 0 68-68a28 28 0 0 0-56 0a12 12 0 0 1-12 12h-4V56a40 40 0 0 0-80 0v32h-4a12 12 0 0 1-12-12a28 28 0 0 0-56 0a68.07 68.07 0 0 0 68 68h4v64H40a8 8 0 0 0 0 16h176a8 8 0 0 0 0-16ZM96 128H84a52.06 52.06 0 0 1-52-52a12 12 0 0 1 24 0a28 28 0 0 0 28 28h12a8 8 0 0 0 8-8V56a24 24 0 0 1 48 0v80a8 8 0 0 0 8 8h12a28 28 0 0 0 28-28a12 12 0 0 1 24 0a52.06 52.06 0 0 1-52 52h-12a8 8 0 0 0-8 8v32h-48v-72a8 8 0 0 0-8-8Z">
                              </path>
                            </g>
                          </svg><span class="font-sans text-xs">Personal V3</span></a>
                      </li>
                    </ul>
                  </div>
                </li>
                <li class="group mb-1 min-h-[2rem]">
                  <a href="#" class="nui-focus relative top-0.5 flex items-center"><span
                      class="text-muted-400 group-hover:text-primary-500 relative inline-flex items-center gap-2 font-sans text-sm transition-colors duration-300"><!----><span>Finance</span></span><svg
                      data-v-cd102a71="" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                      aria-hidden="true" role="img"
                      class="icon text-muted-400 ms-auto block h-4 w-4 transition-transform duration-300 group-focus-within:rotate-180"
                      width="1em" height="1em" viewBox="0 0 24 24">
                      <path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                        stroke-width="2" d="m6 9l6 6l6-6"></path>
                    </svg></a>
                  <div
                    class="transition-all duration-150 max-h-0 overflow-hidden opacity-0 group-focus-within:max-h-max group-focus-within:overflow-visible group-focus-within:opacity-100">
                    <ul class="py-2">
                      <li class="flex h-8 w-full items-center">
                        <a href="/dashboards/analytics"
                          ...
                          </svg><span class="font-sans text-xs">Analytics dashboard</span></a>
                      </li>
                      <li class="flex h-8 w-full items-center">
                        <a href="/dashboards/stocks"
                          class="nui-focus text-muted-400 hover:text-primary-500 focus:text-primary-500 flex w-full items-center ps-3 transition-colors duration-300"><svg
                            data-v-cd102a71="" xmlns="http://www.w3.org/2000/svg"
                            xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img"
                            class="icon me-2 h-5 w-5" width="1em" height="1em" viewBox="0 0 256 256">
                            <g fill="currentColor">
                              <path d="M232 104c0 24-40 48-104 48S24 128 24 104s40-48 104-48s104 24 104 48Z" opacity=".2">
                              </path>
                              <path
                                d="M207.58 63.84C186.85 53.48 159.33 48 128 48s-58.85 5.48-79.58 15.84S16 88.78 16 104v48c0 15.22 11.82 29.85 32.42 40.16S96.67 208 128 208s58.85-5.48 79.58-15.84S240 167.22 240 152v-48c0-15.22-11.82-29.85-32.42-40.16ZM128 64c62.64 0 96 23.23 96 40s-33.36 40-96 40s-96-23.23-96-40s33.36-40 96-40Zm-8 95.86v32c-19-.62-35-3.42-48-7.49v-31.32a203.43 203.43 0 0 0 48 6.81Zm16 0a203.43 203.43 0 0 0 48-6.81v31.31c-13 4.07-29 6.87-48 7.49ZM32 152v-18.47a82.88 82.88 0 0 0 16.42 10.63c2.43 1.21 5 2.35 7.58 3.43V178c-15.83-7.84-24-17.71-24-26Zm168 26v-30.41c2.61-1.08 5.15-2.22 7.58-3.43A82.88 82.88 0 0 0 224 133.53V152c0 8.29-8.17 18.16-24 26Z">
                              </path>
                            </g>
                          </svg><span class="font-sans text-xs">Stock dashboard</span></a>
                      </li>
                      <li class="flex h-8 w-full items-center">
                        <a href="/dashboards/sales"
                          class="nui-focus text-muted-400 hover:text-primary-500 focus:text-primary-500 flex w-full items-center ps-3 transition-colors duration-300"><svg
                            data-v-cd102a71="" xmlns="http://www.w3.org/2000/svg"
                            xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img"
                            class="icon me-2 h-5 w-5" width="1em" height="1em" viewBox="0 0 256 256">
                          ...
                          </svg><span class="font-sans text-xs">Sales dashboard</span></a>
                      </li>
                    </ul>
                  </div>
                </li>
                <li class="group mb-1 min-h-[2rem]">
                  <a href="#" class="nui-focus relative top-0.5 flex items-center"><span
                      class="text-muted-400 group-hover:text-primary-500 relative inline-flex items-center gap-2 font-sans text-sm transition-colors duration-300"><!----><span>Banking</span></span><svg
                      data-v-cd102a71="" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                      aria-hidden="true" role="img"
                      class="icon text-muted-400 ms-auto block h-4 w-4 transition-transform duration-300 group-focus-within:rotate-180"
                      width="1em" height="1em" viewBox="0 0 24 24">
                        ...
                        <a href="/dashboards/banking-1"
                          class="nui-focus text-muted-400 hover:text-primary-500 focus:text-primary-500 flex w-full items-center ps-3 transition-colors duration-300"><svg
                            ...
                            <g fill="currentColor">
                              ...
                              <path
                                d="M24 104h24v64H32a8 8 0 0 0 0 16h192a8 8 0 0 0 0-16h-16v-64h24a8 8 0 0 0 4.19-14.81l-104-64a8 8 0 0 0-8.38 0l-104 64A8 8 0 0 0 24 104Zm40 0h32v64H64Zm80 0v64h-32v-64Zm48 64h-32v-64h32ZM128 41.39L203.74 88H52.26ZM248 208a8 8 0 0 1-8 8H16a8 8 0 0 1 0-16h224a8 8 0 0 1 8 8Z">
                              </path>
                            </g>
                          </svg><span class="font-sans text-xs">Banking V1</span></a>
                      </li>
                      <li class="flex h-8 w-full items-center">
                        <a href="/dashboards/banking-2"
                          class="nui-focus text-muted-400 hover:text-primary-500 focus:text-primary-500 flex w-full items-center ps-3 transition-colors duration-300"><svg
                            data-v-cd102a71="" xmlns="http://www.w3.org/2000/svg"
                            xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img"
                            class="icon me-2 h-5 w-5" width="1em" height="1em" viewBox="0 0 256 256">
                          ...
                          </svg><span class="font-sans text-xs">Banking V2</span></a>
                      </li>
                      <li class="flex h-8 w-full items-center">
                        <a href="/dashboards/banking-3"
                          class="nui-focus text-muted-400 hover:text-primary-500 focus:text-primary-500 flex w-full items-center ps-3 transition-colors duration-300"><svg
                            data-v-cd102a71="" xmlns="http://www.w3.org/2000/svg"
                            xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img"
                            class="icon me-2 h-5 w-5" width="1em" height="1em" viewBox="0 0 256 256">
                          ...
                          </svg><span class="font-sans text-xs">Banking V3</span></a>
                      </li>
                    </ul>
                  </div>
                </li>
                <li class="group mb-1 min-h-[2rem]">
                  <a href="#" class="nui-focus relative top-0.5 flex items-center"><span
                      class="text-muted-400 group-hover:text-primary-500 relative inline-flex items-center gap-2 font-sans text-sm transition-colors duration-300"><!----><span>Business</span></span><svg
                      data-v-cd102a71="" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                      aria-hidden="true" role="img"
                      class="icon text-muted-400 ms-auto block h-4 w-4 transition-transform duration-300 group-focus-within:rotate-180"
                      width="1em" height="1em" viewBox="0 0 24 24">
                    ...
                    <ul class="py-2">
                      ...
                      <li class="flex h-8 w-full items-center">
                        <a href="/dashboards/company"
                          ...
                          </svg><span class="font-sans text-xs">Company board</span></a>
                      </li>
                      <li class="flex h-8 w-full items-center">
                        <a href="/dashboards/human-resources"
                          class="nui-focus text-muted-400 hover:text-primary-500 focus:text-primary-500 flex w-full items-center ps-3 transition-colors duration-300"><svg
                            data-v-cd102a71="" xmlns="http://www.w3.org/2000/svg"
                            xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img"
                            class="icon me-2 h-5 w-5" width="1em" height="1em" viewBox="0 0 256 256">
                      ...
                      <li class="flex h-8 w-full items-center">
                        <a href="/dashboards/course"
                          ...
                          </svg><span class="font-sans text-xs">Course dashboard</span></a>
                      </li>
                      <li class="flex h-8 w-full items-center">
                        <a href="/dashboards/jobs"
                          class="nui-focus text-muted-400 hover:text-primary-500 focus:text-primary-500 flex w-full items-center ps-3 transition-colors duration-300"><svg
                            data-v-cd102a71="" xmlns="http://www.w3.org/2000/svg"
                            xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img"
                            class="icon me-2 h-5 w-5" width="1em" height="1em" viewBox="0 0 256 256">
                          ...
                          </svg><span class="font-sans text-xs">Jobs dashboard</span></a>
                      </li>
                    </ul>
                  </div>
                </li>
                <li class="group mb-1 min-h-[2rem]">
                  <a href="#" class="nui-focus relative top-0.5 flex items-center"><span
                      class="text-muted-400 group-hover:text-primary-500 relative inline-flex items-center gap-2 font-sans text-sm transition-colors duration-300"><!----><span>Lifestyle</span></span><svg
                      data-v-cd102a71="" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                      aria-hidden="true" role="img"
                      class="icon text-muted-400 ms-auto block h-4 w-4 transition-transform duration-300 group-focus-within:rotate-180"
                      width="1em" height="1em" viewBox="0 0 24 24">
                    ...
                    <ul class="py-2">
                      ...
                      <li class="flex h-8 w-full items-center">
                        <a href="/dashboards/hobbies"
                          ...
                          </svg><span class="font-sans text-xs">Hobbies</span></a>
                      </li>
                      <li class="flex h-8 w-full items-center">
                        <a href="/dashboards/health"
                          class="nui-focus text-muted-400 hover:text-primary-500 focus:text-primary-500 flex w-full items-center ps-3 transition-colors duration-300"><svg
                            data-v-cd102a71="" xmlns="http://www.w3.org/2000/svg"
                            xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img"
                            class="icon me-2 h-5 w-5" width="1em" height="1em" viewBox="0 0 256 256">
                            <g fill="currentColor">
                              <path d="m160 160l-50.75 50.75a45.26 45.26 0 0 1-64 0a45.26 45.26 0 0 1 0-64L96 96Z"
                                opacity=".2"></path>
                              <path
                                d="M216.43 39.6a53.27 53.27 0 0 0-75.33 0L39.6 141.09a53.26 53.26 0 0 0 75.32 75.31l101.51-101.49a53.32 53.32 0 0 0 0-75.31ZM103.61 205.09a37.26 37.26 0 0 1-52.7-52.69L96 107.31L148.7 160Zm101.5-101.49L160 148.69L107.32 96l45.1-45.09a37.26 37.26 0 0 1 52.69 52.69Zm-15.43-21.26a8 8 0 0 1 0 11.32l-24 24a8 8 0 1 1-11.31-11.32l24-24a8 8 0 0 1 11.31 0Z">
                              </path>
                            </g>
                          </svg><span class="font-sans text-xs">Health</span></a>
                      </li>
                      <li class="flex h-8 w-full items-center">
                        <a href="/dashboards/writer"
                          class="nui-focus text-muted-400 hover:text-primary-500 focus:text-primary-500 flex w-full items-center ps-3 transition-colors duration-300"><svg
                            data-v-cd102a71="" xmlns="http://www.w3.org/2000/svg"
                            xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img"
                            class="icon me-2 h-5 w-5" width="1em" height="1em" viewBox="0 0 256 256">
                            <g fill="currentColor">
                              <path
                                d="M120 56L60.32 78.38a8 8 0 0 0-5.08 6.17L32 224l139.45-23.24a8 8 0 0 0 6.17-5.08L200 136Zm-4 104a20 20 0 1 1 20-20a20 20 0 0 1-20 20Z"
                                opacity=".2"></path>
                              <path
                          ...
                          </svg><span class="font-sans text-xs">Writer</span></a>
                      </li>
                      <li class="flex h-8 w-full items-center">
                        <a href="/dashboards/video"
                          class="nui-focus text-muted-400 hover:text-primary-500 focus:text-primary-500 flex w-full items-center ps-3 transition-colors duration-300"><svg
                            data-v-cd102a71="" xmlns="http://www.w3.org/2000/svg"
                            xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img"
                            class="icon me-2 h-5 w-5" width="1em" height="1em" viewBox="0 0 256 256">
                          ...
                          </svg><span class="font-sans text-xs">Video</span></a>
                      </li>
                      <li class="flex h-8 w-full items-center">
                        <a href="/dashboards/soccer"
                          class="nui-focus text-muted-400 hover:text-primary-500 focus:text-primary-500 flex w-full items-center ps-3 transition-colors duration-300"><svg
                            data-v-cd102a71="" xmlns="http://www.w3.org/2000/svg"
                            xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img"
                            class="icon me-2 h-5 w-5" width="1em" height="1em" viewBox="0 0 256 256">
                          ...
                          </svg><span class="font-sans text-xs">Soccer</span></a>
                      </li>
                    </ul>
                  </div>
                </li>
                <li class="group mb-1 min-h-[2rem]">
                  <a href="#" class="nui-focus relative top-0.5 flex items-center"><span
                      class="text-muted-400 group-hover:text-primary-500 relative inline-flex items-center gap-2 font-sans text-sm transition-colors duration-300"><!----><span>Ecommerce</span></span><svg
                      data-v-cd102a71="" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                      aria-hidden="true" role="img"
                      class="icon text-muted-400 ms-auto block h-4 w-4 transition-transform duration-300 group-focus-within:rotate-180"
                      width="1em" height="1em" viewBox="0 0 24 24">
                    ...
                    <ul class="py-2">
                      <li class="flex h-8 w-full items-center">
                        <a href="/dashboards/ecommerce"
                          ...
                          </svg><span class="font-sans text-xs">Ecommerce</span></a>
                      </li>
                    </ul>
                  </div>
                </li>
                <li class="group mb-1 min-h-[2rem]">
                  <a href="#" class="nui-focus relative top-0.5 flex items-center"><span
                      class="text-muted-400 group-hover:text-primary-500 relative inline-flex items-center gap-2 font-sans text-sm transition-colors duration-300"><!----><span>Apps</span></span><svg
                      data-v-cd102a71="" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                      aria-hidden="true" role="img"
                      class="icon text-muted-400 ms-auto block h-4 w-4 transition-transform duration-300 group-focus-within:rotate-180"
                      width="1em" height="1em" viewBox="0 0 24 24">
                  ...
                  <div
                    ...
                    <ul class="py-2">
                      <li class="flex h-8 w-full items-center">
                        <a href="/dashboards/delivery"
                          class="nui-focus text-muted-400 hover:text-primary-500 focus:text-primary-500 flex w-full items-center ps-3 transition-colors duration-300"><svg
                            data-v-cd102a71="" xmlns="http://www.w3.org/2000/svg"
                            xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img"
                            class="icon me-2 h-5 w-5" width="1em" height="1em" viewBox="0 0 256 256">
                            <g fill="currentColor">
                              <path d="M224 128a96 96 0 1 1-96-96a48 48 0 0 0 48 48a48 48 0 0 0 48 48Z" opacity=".2">
                              </path>
                              <path
                                d="M164.49 163.51a12 12 0 1 1-17 0a12 12 0 0 1 17 0Zm-81-8a12 12 0 1 0 17 0a12 12 0 0 0-16.98 0Zm9-39a12 12 0 1 0-17 0a12 12 0 0 0 17-.02Zm48-1a12 12 0 1 0 0 17a12 12 0 0 0 0-17ZM232 128A104 104 0 1 1 128 24a8 8 0 0 1 8 8a40 40 0 0 0 40 40a8 8 0 0 1 8 8a40 40 0 0 0 40 40a8 8 0 0 1 8 8Zm-16.31 7.39A56.13 56.13 0 0 1 168.5 87.5a56.13 56.13 0 0 1-47.89-47.19a88 88 0 1 0 95.08 95.08Z">
                              </path>
                            </g>
                          </svg><span class="font-sans text-xs">Food delivery</span></a>
                      </li>
                      <li class="flex h-8 w-full items-center">
                        <a href="/dashboards/map-left"
                          class="nui-focus text-muted-400 hover:text-primary-500 focus:text-primary-500 flex w-full items-center ps-3 transition-colors duration-300"><svg
                            data-v-cd102a71="" xmlns="http://www.w3.org/2000/svg"
                            xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img"
                            class="icon me-2 h-5 w-5" width="1em" height="1em" viewBox="0 0 256 256">
                          ...
                          </svg><span class="font-sans text-xs">Maps v1</span></a>
                      </li>
                      <li class="flex h-8 w-full items-center">
                        <a href="/dashboards/map-right"
                          class="nui-focus text-muted-400 hover:text-primary-500 focus:text-primary-500 flex w-full items-center ps-3 transition-colors duration-300"><svg
                            data-v-cd102a71="" xmlns="http://www.w3.org/2000/svg"
                            xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img"
                            class="icon me-2 h-5 w-5" width="1em" height="1em" viewBox="0 0 256 256">
                          ...
                          </svg><span class="font-sans text-xs">Maps v2</span></a>
                      </li>
                      <li class="flex h-8 w-full items-center">
                        <a href="/dashboards/inbox"
                          class="nui-focus text-muted-400 hover:text-primary-500 focus:text-primary-500 flex w-full items-center ps-3 transition-colors duration-300"><svg
                            data-v-cd102a71="" xmlns="http://www.w3.org/2000/svg"
                            xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img"
                            class="icon me-2 h-5 w-5" width="1em" height="1em" viewBox="0 0 256 256">
                          ...
                          </svg><span class="font-sans text-xs">Inbox</span></a>
                      </li>
                      <li class="flex h-8 w-full items-center">
                        <a href="/dashboards/messaging"
                          class="nui-focus text-muted-400 hover:text-primary-500 focus:text-primary-500 flex w-full items-center ps-3 transition-colors duration-300"><svg
                            data-v-cd102a71="" xmlns="http://www.w3.org/2000/svg"
                            xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img"
                            class="icon me-2 h-5 w-5" width="1em" height="1em" viewBox="0 0 256 256">
                          ...
                          </svg><span class="font-sans text-xs">Messaging</span></a>
                      </li>
                    </ul>
                  </div>
                </li>
                <li class="border-muted-200 dark:border-muted-700 my-3 h-px w-full border-t"></li>
                <li class="mb-1 flex min-h-[2rem] items-center">
                  <a href="/wizard"
                    class="nui-focus text-muted-400 hover:text-primary-500 flex w-full items-center transition-colors duration-300"><span
                      class="font-sans text-sm">Wizard</span></a>
                </li>
                <li class="border-muted-200 dark:border-muted-700 my-3 h-px w-full border-t"></li>
                <li class="group mb-1 min-h-[2rem]">
                  <a href="#" class="nui-focus relative top-0.5 flex items-center"><span
                      class="text-muted-400 group-hover:text-primary-500 relative inline-flex items-center gap-2 font-sans text-sm transition-colors duration-300"><!----><span>Charts</span></span><svg
                      data-v-cd102a71="" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                      aria-hidden="true" role="img"
                      class="icon text-muted-400 ms-auto block h-4 w-4 transition-transform duration-300 group-focus-within:rotate-180"
                      width="1em" height="1em" viewBox="0 0 24 24">
                    ...
                    <ul class="py-2">
                      <li class="flex h-8 w-full items-center">
                        <a href="/dashboards/charts"
                          ...
                          </svg><span class="font-sans text-xs">Apex Charts</span></a>
                      </li>
                    </ul>
                  </div>
                </li>
                <li class="group mb-1 min-h-[2rem]">
                  <a href="#" class="nui-focus relative top-0.5 flex items-center"><span
                      class="text-muted-400 group-hover:text-primary-500 relative inline-flex items-center gap-2 font-sans text-sm transition-colors duration-300"><!----><span>Widgets</span></span><svg
                      data-v-cd102a71="" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                      aria-hidden="true" role="img"
                      class="icon text-muted-400 ms-auto block h-4 w-4 transition-transform duration-300 group-focus-within:rotate-180"
                      width="1em" height="1em" viewBox="0 0 24 24">
                  ...
                  <div
                    ...
                    <ul class="py-2">
                      <li class="flex h-8 w-full items-center">
                        <a href="/dashboards/widgets"
                          class="nui-focus text-muted-400 hover:text-primary-500 focus:text-primary-500 flex w-full items-center ps-3 transition-colors duration-300"><svg
                            data-v-cd102a71="" xmlns="http://www.w3.org/2000/svg"
                            xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img"
                            class="icon me-2 h-5 w-5" width="1em" height="1em" viewBox="0 0 256 256">
                            <g fill="currentColor">
                              <path d="M208 56v144a8 8 0 0 1-8 8h-72V48h72a8 8 0 0 1 8 8Z" opacity=".2"></path>
                              <path
                          ...
                          </svg><span class="font-sans text-xs">UI Widgets</span></a>
                      </li>
                      <li class="flex h-8 w-full items-center">
                        <a href="/dashboards/widgets/creative"
                          class="nui-focus text-muted-400 hover:text-primary-500 focus:text-primary-500 flex w-full items-center ps-3 transition-colors duration-300"><svg
                            data-v-cd102a71="" xmlns="http://www.w3.org/2000/svg"
                            xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img"
                            class="icon me-2 h-5 w-5" width="1em" height="1em" viewBox="0 0 256 256">
                          ...
                          </svg><span class="font-sans text-xs">Creative Widgets</span></a>
                      </li>
                      <li class="flex h-8 w-full items-center">
                        <a href="/dashboards/widgets/list"
                          class="nui-focus text-muted-400 hover:text-primary-500 focus:text-primary-500 flex w-full items-center ps-3 transition-colors duration-300"><svg
                            data-v-cd102a71="" xmlns="http://www.w3.org/2000/svg"
                            xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img"
                            class="icon me-2 h-5 w-5" width="1em" height="1em" viewBox="0 0 256 256">
                          ...
                          </svg><span class="font-sans text-xs">List Widgets</span></a>
                      </li>
                    </ul>
                  </div>
                </li>
          ...
          <div class="flex items-center gap-2 h-16">
            ...
            <div class="group inline-flex items-center justify-center text-right">
              <div data-headlessui-state="" class="relative h-9 w-9 text-left">
                <div id="headlessui-menu-button-315" aria-haspopup="menu" aria-expanded="false" data-headlessui-state="">
                  <button type="button"
                    ...
                    <span
                      class="border-muted-200 dark:border-muted-700 dark:bg-muted-800 flex h-9 w-9 items-center justify-center rounded-full border bg-white"><svg
                        xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true"
                        role="img" class="icon text-muted-400 h-5 w-5" style="" width="1em" height="1em"
                        viewBox="0 0 256 256" data-v-cd102a71="">
                        <g fill="currentColor">
                          <path
            ...
            <!--]--><!--[--><button type="button"
              ...
              <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true"
                role="img" class="icon text-muted-400 h-5 w-5" style="" width="1em" height="1em" viewBox="0 0 256 256"
                data-v-cd102a71="">
                <g fill="currentColor">
                  <path
            ...
            <div class="group inline-flex items-center justify-center text-right">
              <div data-headlessui-state="" class="relative h-9 w-9 text-left">
                <button
                  ...
                  id="headlessui-menu-button-317" aria-haspopup="menu" aria-expanded="false" type="button">
